...
namespace HoloLensWithOpenCVForUnityExample
{
    ...
    public class HoloLensCamTracker : ExampleSceneBase
    {
...
#endif
        {
            ...
            //ray = cameraInstance.ScreenPointToRay(new Vector3(webCamTextureToMatHelper.GetMat().width() * 2 / 3, webCamTextureToMatHelper.GetMat().width() * 2 / 3, 0)); //28n here we got a not null ray
