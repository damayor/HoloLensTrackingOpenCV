...
public class CameraStreamHelperBak : MonoBehaviour
{
    event OnVideoCaptureResourceCreatedCallback VideoCaptureCreated;

    static VideoCapture videoCapture;

    static CameraStreamHelperBak instance;
    public static CameraStreamHelperBak Instance
    {
        get
        {
            return instance;
    ...
    private void OnVideoCaptureInstanceCreated(VideoCapture videoCapture)
    {
        ...
        CameraStreamHelperBak.videoCapture = videoCapture;
