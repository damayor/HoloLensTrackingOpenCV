...
namespace OpenCVForUnity
{
    ...
    public class Imgproc
    {
        ...
        Mat retVal = new Mat(imgproc_Imgproc_getDefaultNewCameraMatrix_11(cameraMatrix.nativeObj, imgsize.width, imgsize.height));
        ...
        Mat retVal = new Mat(imgproc_Imgproc_getDefaultNewCameraMatrix_12(cameraMatrix.nativeObj));
...
RotatedRect retVal = new RotatedRect (tmpArray);
        ...
        float retVal = imgproc_Imgproc_initWideAngleProjMap_11(cameraMatrix.nativeObj, distCoeffs.nativeObj, imageSize.width, imageSize.height, destImageWidth, m1type, map1.nativeObj, map2.nativeObj, projType);
        ...
        float retVal = imgproc_Imgproc_initWideAngleProjMap_12(cameraMatrix.nativeObj, distCoeffs.nativeObj, imageSize.width, imageSize.height, destImageWidth, m1type, map1.nativeObj, map2.nativeObj);
        ...
        imgproc_Imgproc_sqrBoxFilter_12(_src.nativeObj, _dst.nativeObj, ddepth, ksize.width, ksize.height, anchor.x, anchor.y);
        ...
        imgproc_Imgproc_sqrBoxFilter_13(_src.nativeObj, _dst.nativeObj, ddepth, ksize.width, ksize.height);
        ...
        imgproc_Imgproc_undistortPoints_11(src.nativeObj, dst.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj, R.nativeObj);
        ...
        imgproc_Imgproc_undistortPoints_12(src.nativeObj, dst.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj);
    ...
    return retVal;
        ...
        [DllImport (LIBNAME)]
        private static extern IntPtr imgproc_Imgproc_getDefaultNewCameraMatrix_11 (IntPtr cameraMatrix_nativeObj, double imgsize_width, double imgsize_height);
        [DllImport (LIBNAME)]
        private static extern IntPtr imgproc_Imgproc_getDefaultNewCameraMatrix_12 (IntPtr cameraMatrix_nativeObj);
        ...
        [DllImport (LIBNAME)]
        private static extern float imgproc_Imgproc_initWideAngleProjMap_11 (IntPtr cameraMatrix_nativeObj, IntPtr distCoeffs_nativeObj, double imageSize_width, double imageSize_height, int destImageWidth, int m1type, IntPtr map1_nativeObj, IntPtr map2_nativeObj, int projType);
        [DllImport (LIBNAME)]
        private static extern float imgproc_Imgproc_initWideAngleProjMap_12 (IntPtr cameraMatrix_nativeObj, IntPtr distCoeffs_nativeObj, double imageSize_width, double imageSize_height, int destImageWidth, int m1type, IntPtr map1_nativeObj, IntPtr map2_nativeObj);
        ...
        [DllImport (LIBNAME)]
        private static extern void imgproc_Imgproc_sqrBoxFilter_12 (IntPtr _src_nativeObj, IntPtr _dst_nativeObj, int ddepth, double ksize_width, double ksize_height, double anchor_x, double anchor_y);
        [DllImport (LIBNAME)]
        private static extern void imgproc_Imgproc_sqrBoxFilter_13 (IntPtr _src_nativeObj, IntPtr _dst_nativeObj, int ddepth, double ksize_width, double ksize_height);
        ...
        [DllImport (LIBNAME)]
        private static extern void imgproc_Imgproc_undistortPoints_11 (IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr cameraMatrix_nativeObj, IntPtr distCoeffs_nativeObj, IntPtr R_nativeObj);
        [DllImport (LIBNAME)]
        private static extern void imgproc_Imgproc_undistortPoints_12 (IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr cameraMatrix_nativeObj, IntPtr distCoeffs_nativeObj);
