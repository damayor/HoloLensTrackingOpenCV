...
namespace OpenCVForUnityExample
{
    ...
    /// </summary>
    public class CascadeDescriptorExample : MonoBehaviour
    {
        /// <summary>
        /// The videoCapture.
        /// </summary>
        ...
        void Start ()
        {
            ...
            #else
            string videopath = Utils.getFilePath ("768x576_mjpeg.mjpeg"); ////"1920x1080_avi.avi" why the second isn't opened, 30X
        ...
        private void Init ()
        {
            ...
            des = new CascadeClassifier(Utils.getFilePath("cars.xml"));
        }
